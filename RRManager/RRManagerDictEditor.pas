unit RRManagerDictEditor;

interface

uses
  Windows, Messages, SysUtils, Classes, Graphics, Controls, Forms, Dialogs,
  StdCtrls, CommonComplexList; 
...
uses Facade, BaseDicts;

{$R *.DFM}

procedure TfrmDictEditor.FormCreate(Sender: TObject);
begin
  (TMainFacade.GetInstance as TMainFacade).AllDicts.MakeDictList(cmbxDict.Items, true);
