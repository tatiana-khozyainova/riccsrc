...
uses
  Forms, Messages, SysUtils, Windows,
...
str:string;//tooltips_class32
begin
  H:=CreateMutex(nil, True, 'rbdgi_launcher');
  if GetLastError = ERROR_ALREADY_EXISTS then
  begin
  //Application.MessageBox('Приложение уже запущено!','Внимание',MB_OK+MB_ICONINFORMATION);
  {GetClassName(h,Buff,SizeOf(Buff));
  str:=string(Buff);
  Application.MessageBox(PAnsiChar(str),'Внимание',MB_OK+MB_ICONINFORMATION);}
  H2:=FindWindow(nil,'РБЦГИ');
